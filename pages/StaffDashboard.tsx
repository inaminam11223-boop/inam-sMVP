    ...
    <div className="space-y-8 pb-20 animate-in fade-in duration-500">
      <div className="bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col md:flex-row items-center gap-8 transition-colors">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-slate-500 dark:text-slate-400 font-bold uppercase text-xs tracking-widest mt-1">Staff: <span className="text-blue-600 dark:text-blue-400 uppercase">DANYIAL HOTI</span> @ {business.name}</p>
